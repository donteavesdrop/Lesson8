...
import ru.mirea.zakharova.yandexmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.zakharova.yandexmaps.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
    ...
    public void onObjectAdded(UserLocationView userLocationView) {
        ...
        userLocationView.getArrow().setIcon(ImageProvider.fromResource(this, R.drawable.search_result2));
        // При получении координат местоположения устанавливается следующая иконка
        CompositeIcon pinIcon = userLocationView.getPin().useCompositeIcon();
        pinIcon.setIcon(
                "pin",
                ImageProvider.fromResource(this, R.drawable.search_result), new IconStyle().setAnchor(new PointF(0.5f, 0.5f))
