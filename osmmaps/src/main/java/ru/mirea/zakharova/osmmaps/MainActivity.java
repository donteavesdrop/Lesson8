package ru.mirea.zakharova.osmmaps;
...
import ru.mirea.zakharova.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.zakharova.osmmaps.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        ...
        marker.setOnMarkerClickListener((marker1, mapView) -> {
            Toast.makeText(getApplicationContext(),"MIREA RTU - корпус на Вернадского",
        ...
        marker2.setOnMarkerClickListener((marker21, mapView) -> {
            Toast.makeText(getApplicationContext(),"MIREA RTU - корпус на Стромынке",
                    Toast.LENGTH_SHORT).show();
            return true;
        });
        ...
        marker3.setPosition(new GeoPoint(55.73163, 37.575));
        marker3.setOnMarkerClickListener((marker31, mapView) -> {
            Toast.makeText(getApplicationContext(),"MIREA RTU - корпус на Малой Пироговской",
                    Toast.LENGTH_SHORT).show();
            return true;
        });
